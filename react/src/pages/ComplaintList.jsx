            ...
            {complaints.map((complaint) => (
                ...
                >
                    <div className="flex items-center justify-between mb-4">
                        ...
                        <span className={`inline-flex items-center space-x-1 px-2 py-1 rounded-full text-xs font-medium ${getPriorityColor(complaint.priority)}`}>
                                ...
                                if (
                                    ...
                                    return (
                                        <button
                                            ...
                                            className={`px-4 py-2 rounded-xl text-sm font-medium transition-colors ${pagination.currentPage === page
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="grid grid-cols-2 gap-4">
                                        <div>
                                            ...
                                            <span className={`inline-flex items-center space-x-1 px-3 py-1 rounded-full text-xs font-medium border ${getStatusColor(selectedComplaint.status)}`}>
                                        ...
                                        <div>
                                            ...
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium ${getPriorityColor(selectedComplaint.priority)}`}>
                                                {getPriorityLabel(selectedComplaint.priority)}
                                            </span>
                                        </div>
                                        {selectedComplaint.status !== 'resolved' && (
                                            <button
                                                 onClick={() => handleMarkResolved(selectedComplaint.category_id,selectedComplaint.id)}
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-gray-50 rounded-xl p-4">
                                            <p className="text-gray-700">
                                                ...
                                                <strong>Name:</strong> {selectedComplaint.citizen_name}<br />
                                                <strong>Email:</strong> {selectedComplaint.citizen_email}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-gray-50 rounded-xl p-4">
                                            <p className="text-gray-700">
                                                {selectedComplaint.city_name}, {selectedComplaint.location_name}
                                            </p>
                                        </div>
                                    </div>
                                    ...
                                    <div>
                                        ...
                                        <div className="bg-gray-50 rounded-xl p-4">
                                            <p className="text-gray-700">{selectedComplaint.department_name}</p>
                                        </div>
                                    </div>
